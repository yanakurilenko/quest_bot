...
def save_user_data(result):
    with open("../quest_bot/user_data.json", "r") as file:
        users_data = json.load(file)
    users_data.update(result)
    with open("../quest_bot/user_data.json", "w") as file:
...
def handle_go(message):
    bot.send_photo(message.chat.id, open('../quest_bot/cave1.jpg', 'rb'))
    ...
    bot.send_photo(message.chat.id, open('../quest_bot/bats.jpg', 'rb'))
...
def handle_choices(message):
    ...
    if message.text ==locations['cave']['choice1']:
        ...
        bot.send_photo(message.chat.id, open('../quest_bot/apple_tree1.jpg', 'rb'))
        ...
        bot.send_photo(message.chat.id, open('../quest_bot/beach.jpg', 'rb'))
        return bot.send_message(message.chat.id, "Что будешь делать?", reply_markup=keyboard)
        ...
        save_user_data(user_dict)
        bot.send_photo(message.chat.id, open('../quest_bot/apple.jpg', 'rb'))
        bot.send_message(message.chat.id,locations['results']['lose2'])
        bot.send_photo(message.chat.id, open('../quest_bot/goat.jpg', 'rb'))
        ...
        bot.send_photo(message.chat.id, open('../quest_bot/sharks1.jpg', 'rb'))
        bot.send_message(message.chat.id, again)
        ...
        bot.send_photo(message.chat.id, open('../quest_bot/apple_tree4.jpg', 'rb'))
        bot.send_message(message.chat.id, again)
        ...
        bot.send_photo(message.chat.id, open('../quest_bot/fire3.jpg', 'rb'))
        bot.send_photo(message.chat.id, open('../quest_bot/ship5.jpg', 'rb'))
        bot.send_message(message.chat.id, again)
    else:
